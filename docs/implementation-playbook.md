...
- Identity application use cases and real authentication HTTP routes are not wired;
...
Snapshot date: **30 July 2026**. Inspect the current tree and update this table before assigning work;
the repository, not this snapshot, is authoritative.

| Epic                  | Initial status      | Existing foundation                                              | First recommended packet                          |
| --------------------- | ------------------- | ---------------------------------------------------------------- | ------------------------------------------------- |
| P1-E1                 | Partial foundation  | Identity domain, security adapters, persistence, and migration   | P1-E1-W01, then W02                               |
