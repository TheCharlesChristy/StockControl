...
[product requirements section 16.1](./product-requirements-full-v1.md#161-explicitly-deferred) must not
...
1. A current explicit product-owner instruction for task scope. If it changes the approved product,
   ...
   baseline.
2. [Approved product requirements](./product-requirements-full-v1.md).
...
6. [Requirements traceability](./requirements-traceability-v1.md).
7. This playbook.
...
[requirements traceability](./requirements-traceability-v1.md) with exact executable evidence.
...
1. revise [product requirements](./product-requirements-full-v1.md), including acceptance and MVP boundary;
2. add a superseding ADR rather than rewriting an accepted decision silently;
3. update [requirements traceability](./requirements-traceability-v1.md);
